    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="帖子状态" prop="forumStateTypes">
                        <el-select v-model="ruleForm.forumStateTypes" placeholder="请选择帖子状态">
                            <el-option
                                v-for="(item,index) in forumStateTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="帖子状态" prop="forumStateValue">
                        <el-input v-model="ruleForm.forumStateValue"
